...
To investigate how the results of a fEVE instance are impacted by the parameters used, a benchmark can be conducted easily.
We will demonstrate how by using the scEVE instance, an instance dedicated to the analysis of scRNA-seq datasets.
